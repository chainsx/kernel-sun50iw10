...
static void do_usb_role_null(struct usb_msg_center_info *center_info)
{
	if (center_info->msg.hw_insmod_host) {
		...
		extern void axp2202_usb_host_extcon(void);
		extern void axp2202_boosten(int en);
		axp2202_boosten(true);
		axp2202_usb_host_extcon();
#endif
...
#if defined(CONFIG_EXTCON) && defined(CONFIG_AXP2202_POWER)
		extern void axp2202_usb_device_extcon(void);
		axp2202_usb_device_extcon();
#endif
...
#if defined(CONFIG_EXTCON) && defined(CONFIG_AXP2202_POWER)
		extern void axp2202_usb_null_extcon(void);
		extern void axp2202_boosten(int en);
		axp2202_boosten(false);
		axp2202_usb_null_extcon();
#endif
